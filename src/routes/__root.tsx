...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MailPilot — AI Email Monitoring & Task Automation" },
      { name: "description", content: "Enterprise AI agent that monitors mailboxes, classifies emails, and automates ClickUp task creation." },
      { property: "og:title", content: "MailPilot — AI Email Monitoring & Task Automation" },
      { property: "og:description", content: "Enterprise AI agent that monitors mailboxes, classifies emails, and automates ClickUp task creation." },
